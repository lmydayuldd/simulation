 ...
 */
public class RoadWorkSign implements SimulationLoopExecutable, PhysicalObject {
    ...
    public void setCollision(boolean collision) {
        Log.warning("RoadWorkSign: setCollision - collision: " + collision + ", RoadWorkSign at start: " + this);
        this.collision = collision;
        Log.warning("RoadWorkSign: setCollision - collision: " + collision + ", RoadWorkSign at end: " + this);
    }
